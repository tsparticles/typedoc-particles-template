...
export function initParticles() {
    ...
    let bigBubbles: RecursivePartial<IOptions & IEmitterOptions> = {
        fpsLimit: 60,
        particles: {
            number: {
                value: 50,
    ...
    let slack: RecursivePartial<IOptions> = {
        fpsLimit: 60,
        particles: {
            number: {
                value: 80,
    ...
    let mouseTrail: RecursivePartial<IOptions> = {
        fpsLimit: 60,
        particles: {
            number: {
                value: 0,
    ...
    let fruits: RecursivePartial<IOptions> = {
        detectRetina: true,
        fpsLimit: 60,
        interactivity: {
            detectsOn: "window",
    ...
    let disappearing: RecursivePartial<IOptions & IEmitterOptions> = {
        background: {
            color: {
                value: "#fff"
            }
    ...
    let bgMask: RecursivePartial<IOptions> = {
        fpsLimit: 60,
        particles: {
            number: {
                value: 200,
    ...
    let basic: RecursivePartial<IOptions> = {
        "fpsLimit": 60,
        "particles": {
            "number": {
                "value": 80,
    ...
    let planes: RecursivePartial<IOptions> = {
        "fpsLimit": 60,
        "interactivity": {
            "detect_on": "window",
            "events": {
    ...
    let emitterNoiseTrails: RecursivePartial<IOptions & IEmitterOptions> = {
        fps_limit: 999,
        emitters: [
            {
                life: {
    ...
    let snow: RecursivePartial<IOptions> = {
        fps_limit: 60,
        interactivity: {
            detect_on: "window",
            events: {
